...
class Config(object):
    ...
    ALIVE_MSG = os.environ.get("ALIVE_MSG", "⚡ ℓεgεη∂αяү αғ ∂3vιℓвσт ⚡")
    ALIVE_PIC = os.environ.get("ALIVE_PIC", "https://telegra.ph/file/e441ee749e930d4f99a6d.jpg")
    ...
    if AUTH_TOKEN_DATA != None:
        ...
        t_file.close()
    BIO_MSG = os.environ.get("BIO_MSG", "ℓεgεη∂αяү αғ ∂3vιℓвσт")
    ...
    PMPERMIT_PIC = os.environ.get("PMPERMIT_PIC", "https://telegra.ph/file/4bdc47569507347ed194c.jpg")
