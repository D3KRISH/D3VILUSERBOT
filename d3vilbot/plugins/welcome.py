...
from mafiabot.sql.welcome_sql import get_current_welcome, add_welcome, rm_welcome, update_welcome
from . import *
...
@bot.on(mafia_cmd(pattern="savewelcome(?: |$)(.*)"))
...
@bot.on(mafia_cmd(pattern="cleanwelcome$"))
...
@bot.on(mafia_cmd(pattern="showwelcome$"))
...
@bot.on(mafia_cmd(pattern="welcome_note$"))
