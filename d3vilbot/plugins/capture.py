...
@bot.on(mafia_cmd(pattern="(webshot|screenshot) (.*)", outgoing=True))
...
async def _(event):
    ...
    try:
        ...
        await mafia.edit("Calculating Page Dimensions")
        ...
        await mafia.edit("Painting web-page")
        driver.set_window_size(width + 100, height + 100)
        im_png = driver.get_screenshot_as_png()
        driver.close()
        await mafia.edit("Stopping Google Chrome BIN")
...
CmdHelp("capture").add_command(
        "screenshot", "<link>", "Gives out the web screenshot of given link via Google Crome Bin in .png format", ".screenshot https://github.com/d3boy-op/mafiabot"
).add_command(
