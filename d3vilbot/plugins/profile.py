...
@bot.on(mafia_cmd(pattern="offline$", outgoing=True)) 
async def _(event):
    if event.fwd_from:
        return
    user_it = "me"
...
@bot.on(mafia_cmd(pattern="online$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    user_it = "me"
...
@bot.on(mafia_cmd(pattern="pname (.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(mafia_cmd(outgoing=True, pattern="username (.*)"))
...
@bot.on(mafia_cmd(outgoing=True, pattern="count$"))
...
@bot.on(mafia_cmd(outgoing=True, pattern=r"delpfp"))
...
@bot.on(mafia_cmd(pattern="myusernames$"))
async def _(event):
    if event.fwd_from:
        return
