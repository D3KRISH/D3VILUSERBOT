...
@bot.on(mafia_cmd(pattern=r"boxs$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=r"rain$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=r"deploy$", outgoing=True))
...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](D3KRISH/THE-MAFIABOT)**",
        f"**Build started by user** {mafia_mention}",
        f"**Deploy** `535a74f0` **by user** **{mafia_mention}**",
        ...
        "__INFO:𝔻3𝕍𝕀𝕃𝔹𝕆𝕋:Logged in as 557667062__",
        "__INFO:𝔻3𝕍𝕀𝕃𝔹𝕆𝕋:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@bot.on(mafia_cmd(pattern=r"dump$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=r"fleaveme$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=r"loveu$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=r"plane$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=r"police$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=f"hack$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=r"jio$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=r"solarsystem$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=f"nehi$", outgoing=True))
...
@bot.on(mafia_cmd(pattern="phub$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=r"amore$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=r"sexy$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=r"city", outgoing=True))
...
@bot.on(mafia_cmd(pattern=r"hii", outgoing=True))
...
@bot.on(mafia_cmd(pattern=r"cheer", outgoing=True))
...
@bot.on(mafia_cmd(pattern=r"getwell", outgoing=True))
...
@bot.on(mafia_cmd(pattern="switch$", outgoing=True))
...
async def _(event):
  ...
  #  if input_str == "switch":
    ...
    animation_chars = [
         "⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜[🔲](https://github.com/D3KRISH/THE-MAFIABOT)\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜",
         "⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜[🔲](https://github.com/D3KRISH/THE-MAFIABOT)\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n[👉](https://t.me/D3_krish)⬜⬜⬜⬜⬜⬜",
         "⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜[🔲](https://github.com/D3KRISH/THE-MAFIABOT)\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬛[👉](https://t.me/D3_ktish)⬜⬜⬜⬜⬜",
         "⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜[🔲](https://github.com/D3KRISH/THE-MAFIABOT)\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜\n⬛⬛⬜⬜⬜⬜⬜",
         "⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜[🔲](https://github.com/D3KRISH/THE-MAFIABOT)\n⬜⬜⬜⬜⬜⬜\n⬜⬛⬜⬜⬜⬜⬜\n⬛⬛⬜⬜⬜⬜⬜",
...
@bot.on(mafia_cmd(pattern=r"sprinkle", outgoing=True))
...
@bot.on(mafia_cmd(pattern=r"f", outgoing=True))
...
@bot.on(mafia_cmd(outgoing=True, pattern="kiler( (.*)|$)"))
...
@bot.on(mafia_cmd(pattern="thinking$"))
...
@bot.on(mafia_cmd(pattern=f"snake$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=f"human$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=f"mc$", outgoing=True))
...
@bot.on(mafia_cmd(pattern="virus$"))
...
@bot.on(mafia_cmd(pattern=r"repe$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=f"nikal$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=f"music$", outgoing=True))
...
@bot.on(mafia_cmd(pattern=f"squ$", outgoing=True))
