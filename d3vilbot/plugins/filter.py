...
from . import *
from mafiabot.sql.filter_sql import get_filter, add_filter, remove_filter, get_all_filters, remove_all_filters
...
@bot.on(mafia_cmd(incoming=True))
...
@bot.on(mafia_cmd(pattern=r"filter (.*)"))
...
@bot.on(mafia_cmd(pattern="filters$"))
...
@bot.on(mafia_cmd(pattern="rmallfilters$"))
