...
@bot.on(mafia_cmd(pattern="pat ?(.*)", outgoing=True))
...
@bot.on(mafia_cmd(pattern="join$", outgoing=True))
...
@bot.on(mafia_cmd(pattern="pay$", outgoing=True))
...
@bot.on(mafia_cmd(pattern="climb$", outgoing=True))
...
@bot.on(mafia_cmd(pattern="aag$", outgoing=True))
...
@bot.on(mafia_cmd(pattern="push$", outgoing=True))
...
@bot.on(mafia_cmd(pattern="work$", outgoing=True))
...
@bot.on(mafia_cmd(pattern="suckit$", outgoing=True))
...
@bot.on(mafia_cmd(pattern="ohh$", outgoing=True))
...
@bot.on(mafia_cmd(pattern="lovestory$", outgoing=True))
...
@bot.on(mafia_cmd(pattern="bf$", outgoing=True))
...
@bot.on(mafia_cmd(pattern="session$", outgoing=True))
...
@bot.on(mafia_cmd(pattern="ftext ?(.*)"))
...
@bot.on(mafia_cmd(pattern="cat$"))
@bot.on(sudo_cmd(pattern="cat$", allow_sudo=True))
async def hmm(mafia):
    if mafia.fwd_from:
        return
    reactcat = nekos.textcat()
    await eor(mafia, reactcat)


@bot.on(mafia_cmd(pattern="why$"))
