...
@bot.on(mafia_cmd(pattern=r"magisk"))
...
@bot.on(mafia_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
...
@bot.on(mafia_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(mafia_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(mafia_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
