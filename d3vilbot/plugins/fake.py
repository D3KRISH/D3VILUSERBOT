...
@bot.on(mafia_cmd(pattern="picgen"))
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1676629806:
            await reply_message.reply(
                "`Wait a second, This is my master!`\n**How dare you threaten to ban my master nigger!**\n\n__Your account has been hacked! Pay 69$ to my master__ [D3KRISH](https://t.me/D3_krish) __to release your account__😏"
            )
        else:
            jnl = (
                "`Warning!! `"
