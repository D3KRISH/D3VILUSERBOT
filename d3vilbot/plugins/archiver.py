...
@bot.on(mafia_cmd(pattern="zip", outgoing=True))
...
@bot.on(mafia_cmd(pattern="compress"))
...
@bot.on(mafia_cmd(pattern="unzip"))
...
@bot.on(mafia_cmd(pattern="unrar"))
...
@bot.on(mafia_cmd(pattern="untar"))
